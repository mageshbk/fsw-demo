...
public final class SCAServiceClient {
    ...
    private static final QName SERVICE = new QName( "urn:org.jboss.examples.earproblem:service2:1.0", "MessageLoggerPortType");
    ...
    public static void main(final String[] ignored) throws Exception {
        ...
        message.setService(SERVICE).setOperation("logMesssage").setContent(TEST_MESSAGE);
